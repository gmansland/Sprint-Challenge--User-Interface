...
puts meaning behind your content so its easy for computers and humans to read
...
all members of the team can fork the code edit it then push it back, once approved its added to the main code. so git is great for a team to work on a project.

5. Define mobile-first design in your own words.

page is created for mobiles first. then code is added to keep good style when viewed by other devices
